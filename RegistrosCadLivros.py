def RegistroAcervo ():
    ...
    try:
        desejasair = str(input("Digite a data que deseja filtrar os livros registrados. \nDigite: "))
        arquivo = open('registrosCadLivros.csv',encoding='utf-8')
        ...
        for i in lerlogs:
            ...
            if arquivoaux == desejasair:
                print("Livro: ",arquivoaux2)
                cont += 1
                time.sleep(1)
            else:
                cont = cont
        print("foram inseridos nessa data {} livros".format(cont))
